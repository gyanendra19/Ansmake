...
function BodyPartOne({ }: Props) {
    ...
    // Function for the info of the vaccines
    const vaccineInfo = (logo: any, head: String, text: String) => {
                ...
                <div className='w-[90%] mx-auto'>
                    <div className='md:flex justify-between'>
                        <div className='basis-3/5'>
                            <div className='md:w-[80%] md:mt-20 mt-10'>
                                ...
                                <p className='md:mt-12 mt-6 opacity-70 text-white md:leading-7 md:text-2xl font-medium'>Vaccination.ng will help you find the nearest
                                    centre for vaccination, in all 36 states in Nigeria.</p>

                                <div className="flex md:mt-12 mt-8 gap-6 ml-6 md:ml-0">
                                    <button className='px-4 md:py-2 py-3 md:text-xl text-sm bg-[#17C2EC] text-white font-semibold rounded-[16px]'>Get Vaccine</button>
                                    <button className='px-5 md:text-xl py-3 bg-[#2e2c4d] border-2 border-[#17C2EC] text-white font-semibold text-sm rounded-[16px] '>Help Centre</button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className='flex relative'>
                        <div className='flex flex-col md:flex-row gap-2 md:gap-0 justify-evenly md:w-full h-full absolute md:-top-28 -top-[118px]'>
                            {vaccineInfo(<RiMapPinLine color='#17C2EC' />, 'Location', 'Ikeja Lagos, Nigeria')}
                            {vaccineInfo(<RiCalendarLine color='#17C2EC' />, 'Date', '29 December, 2022')}
                            {vaccineInfo(<RiShieldLine color='#17C2EC' />, 'Vaccine Type', 'Mordena')}
